      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden border border-[#1f1f1f]" style={{ boxShadow: '0 25px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(212,175,55,0.15)' }}>
              <img
                src={aboutImg}
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl text-white mb-4 leading-tight">
              Welcome to{' '}
              <span className="text-gold-gradient">Time Park</span>
            </h2>
            ...
            <p className="text-[#bfbfbf] text-base leading-relaxed mb-4">
              ...
              Vellore's most trusted premium watch showroom, located in the heart of
              Katpadi. We bring you the finest selection of watches from the world's top
              brands — all 100% original and warranty-backed.
            </p>
            <p className="text-[#bfbfbf] text-base leading-relaxed mb-8">
              ...
              Fastrack, or a classic Sonata — Time Park has the perfect timepiece for every
              wrist and every occasion, plus a stunning collection of wall, table, and alarm clocks.
            </p>
