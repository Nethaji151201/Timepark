      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#bfbfbf]">
            Over 10,000+ satisfied customers from Vellore and beyond.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div
              key={t.name}
              className="group bg-[#121212] border border-[#1f1f1f] rounded-2xl p-6 hover:border-[#d4af37]/40 transition-all duration-300 card-hover relative overflow-hidden"
            >
              {/* Quote mark */}
        ...
        {/* Overall rating */}
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 bg-[#121212] border border-[#d4af37]/20 rounded-2xl p-6 max-w-lg mx-auto">
